...
<body>
    <div class= "alert alert-info no-print"><h1>FACTURA DE VENTA</h1> <a href="factura_borrador_2.php"class="btn btn-dark">Regresar</a></div>
<hr>
...
<div class= "container">
  <iframe src="factura_encabezado.php" width="110%" height="160px" frameborder="0"></iframe>
</div>
...
?>
    ...
    <?php echo "<div class='container mt-6 no-print'>
        <div class='row'>
            <div class='col-auto'>
                <a href='eliminar_venta_2.php?id_venta=" . $filas['id_venta'] . "' class='btn btn-danger' onclick='return confirmar()'>ELIMINAR</a>
            </div>
        </div>
    </div>"; ?>
</td>
        ...
        <?php echo "<div class='container mt-3 no-print'>
             ...
             <button class='btn btn-info' onclick='guardarPDF()'>Guardar en PDF</button>
          </div>"; ?>
...
<?php echo "
<div class='container' >
 <form action='nueva_factura_2.php' method='post'>
