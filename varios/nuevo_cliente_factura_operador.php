...
if ($conexion->query($sql_insertar) === TRUE) {
    echo '<script>alert("Datos guardados correctamente");location.assign("factura_borrador_2.php");</script>';
} else {
    echo "<script> alert ('ERROR: Los datos no fueron ingresados a la base de datos'); location.assign ('factura_borrador_2.php'); </script>";
}
...
<div class="container mt-5">
    ...
    <h3>CREAR CLIENTE</h3>
    <a href="factura_borrador_2.php" class="btn btn-dark">Regresar</a>
</div>
    </div>
