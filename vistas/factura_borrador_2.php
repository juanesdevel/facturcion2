...
$diferencia_producto = $_POST['diferencia_producto'];
    ...
    $sql = "INSERT INTO ventas (factura_venta, nom_cliente, doc_cliente_venta, valor_total_venta, caja, asesor_venta, forma_de_pago, unidades_venta, producto_venta, valor_producto, ref_prod_venta) 
        ...
        if ($conexion->query($sql) === TRUE) {
            echo '<script>alert("Producto agregado al carrito");location.assign("factura_borrador_2.php");</script>';
    ...
    <a class="btn btn-info" href="../procesos_factura_admin/admin_cliente_factura">Administrar Cliente</a><hr>
...
function buscarProducto() {
    ...
    $.ajax({
        type: 'POST',
        url: '../procesos_factura_admin_buscar_referencia.php',
