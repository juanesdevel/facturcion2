...
if(isset($_POST['fecha_devo'])){
    ...
    $sql2 = "INSERT INTO devoluciones (fecha_devo, usuario_devo, doc_cliente_devo, id_venta, factura_devo, ref_producto, unidades_pro, valor_devo, tipo_devo, descripcion_devo) 
