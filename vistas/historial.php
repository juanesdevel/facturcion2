...
<div class="container-fluid alert alert-info sombra"><h1>Historial de Cambios</h1> 
         <a href="inicio_admin.php"class="btn btn-dark btn-sm">Regresar</a><span> </span><?php echo "Usuario: ".$_SESSION['usuario'];?></div>
         </div>
