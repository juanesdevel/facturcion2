...
<body>
    ...
    // consulta
        ...
        if($resultado){
            ...
            echo "<script> alert ('ERROR: Los datos no fueron actualizados en la base de datos'); location.assign ('factura_borrador.php'); </script>";
        }
    // Cerrar conexión
    ...
    <div class="container mt-4">
        <div class="alert alert-info">
            ...
            <a href="factura_borrador.php" class="btn btn-dark mb-3">Regresar</a>
        </div>
        <hr>
        <section>
            <div class="container">
